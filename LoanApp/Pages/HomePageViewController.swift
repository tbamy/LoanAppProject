...
//        profileImg.layer.cornerRadius = 10
        ...
        cardContainer.layer.backgroundColor = UIColor(red: 0.404, green: 0.396, blue: 0.91, alpha: 1).cgColor
...
//
//        // Round corners after views are laid out
//        transferView.backgroundColor = UIColor(red: 0.404, green: 0.396, blue: 0.91, alpha: 1)
////        transferView.contentMode = .scaleAspectFit
////        transferView.clipsToBounds = true
////        transferView.layer.cornerRadius = transferView.bounds.width / 2
//
//        requestView.backgroundColor = UIColor(red: 0.404, green: 0.396, blue: 0.91, alpha: 1)
//        requestView.layer.cornerRadius = requestView.frame.width / 2
//
...
//    }
    ...
    func calculateTotalHeight(of subviews: [UIView]) -> CGFloat {
        return subviews.reduce(0) { $0 + $1.frame.height }
    }
